...
common.merge = function (objs) {
  ...
  objs.forEach(function (obj) {
    // Before attempting to operate on `obj`, check if it is truthy. This
    // function is called during the `saveSync` process, and if a function
    // does not have a `saveSync` routine, we'll be passed a `null`.
    if (obj) {
